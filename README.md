...
Rebuild the [Kimina REPL `v4.15.0` branch](https://github.com/VSumanth99/repl/tree/v4.15.0)
and restart the server to enable these fields. For a fresh setup, set
`REPL_BRANCH=v4.15.0`. No full infotree export is needed. Requests without
